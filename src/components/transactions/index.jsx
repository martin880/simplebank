...
const Transactions = ({ history }) => {
  ...
  const submitTransferHandler = (e) => {
    e.preventDefault();
    dispatch(transfer(accountDeposit, accountTransfer, amountTransfer, descTransfer));
  };
    ...
    <Container>
      <Tabs>
        ...
        <TabPanel>
          ...
          <div className="mb-5">
            <h5>Name : {saldoTotal != null && saldoTotal.account ? saldoTotal.account.name : 0} </h5>
            <h5>Account Number : {saldoTotal != null && saldoTotal.account ? saldoTotal.account.account_number : 0} </h5>
            <h5>Total Saldo : {saldoTotal != null && saldoTotal.account ? saldoTotal.account.saldo : 0} </h5>
          </div>
